...
const DetailsBanner = ({ video, crew }) => {
    ...
    const handlePlay = () => {
        ...
        // const newWindow = window.open(`http://api.epicgames.co.ke/${dets?.homepage}`, 'noopener,noreferrer,location=no');
        ...
        const newURL = `https://api.epicgames.co.ke/${dets?.homepage}`;
