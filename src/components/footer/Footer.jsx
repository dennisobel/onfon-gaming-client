                ...
                <Dialog
                    ...
                    sx={{
                        ...
                        "& .MuiDialog-paper": {
                            ...
                            maxHeight: "80%", // Adjust the modal height as needed
                        },
                        "& .MuiDialogContent-root": {
                            dividers: "true", // Use dividers prop for better styling
                        },
                    }}
                >
                    
                        <div className="terms-container custom-dialog">
                    ...
                    <DialogActions>
                        <Button onClick={handleModalClose} autoFocus sx={{color:"#fff"}}>Ok</Button>
                    </DialogActions>
                </Dialog>
            </>
            <footer className="footer">
                <ContentWrapper>
                    <ul className="menuItems">
                        ...
                        <li className="menuItem" onClick={handleModalOpen}>
                            Terms Of Use</li>
